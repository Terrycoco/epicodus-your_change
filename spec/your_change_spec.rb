...
describe('Fixnum#your_change') do
  it('accepts an amount and returns how many quarters') do
    expect(75.your_change()).to(eq('2 quarters, 2 dimes and 1 nickel'))
  ...
  it('accepts an amount and returns how many dimes') do
    expect(80.your_change()).to(eq('2 quarters, 2 dimes and 2 nickels'))
  ...
  it('accepts an amount and returns how many nickels') do
    ...
    expect(90.your_change()).to(eq('2 quarters, 2 dimes and 4 nickels'))
  end

  it('accepts and amount and returns how many pennies') do
    expect(99.your_change()).to(eq('2 quarters, 2 dimes, 4 nickels and 9 pennies'))
